...
function preload()
{
  ...
  bubbleImg = loadImage('bubble2.png'); 
...
function setup() {
  ...
  rope = new Rope(8,{x:40,y:300});
 
  rope3 = new Rope(5,{x:300,y:200});

  ground = new Ground(200,canH,600,20);
  shelf = new Ground(530,canH-420,300,40);

  blink.frameDelay = 20;
  eat.frameDelay = 20;

  bunny = createSprite(370,canH-510,100,100);
  bunny.scale = 0.2;
  ...
  bubble = createSprite(350,380,20,20);
